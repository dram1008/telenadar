...
<div class="container">
    <h1 class="page-header">Словарь</h1>
            ...
            'columns'      => [
                ...
                [
                    ...
                    'content' => function ($model, $key, $index, $column) {
                        return Html::a('Редактировать', ['admin_dictionary/edit', 'id' => $model['id']], [
    ...
    <div class="col-lg-6">
        <div class="row">
            <!-- Split button -->
            <div class="btn-group">
                <a href="<?= Url::to(['admin_dictionary/add']) ?>" class="btn btn-default">Добавить</a>
