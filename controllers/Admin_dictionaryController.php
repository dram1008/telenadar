...
class Admin_dictionaryController extends AdminBaseController
{
    ...
    {
        $model = new \app\models\Form\Dictionary();
    ...
    {
        $model = \app\models\Form\Dictionary::find($id);
    ...
    {
        \app\models\Form\Dictionary::find($id)->delete();
